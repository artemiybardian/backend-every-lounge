...
LOGGING = {
    ...
    'handlers': {
        ...
        'console': {
            ...
            'formatter': 'simple',  # Формат логирования
        },
        # Логирование в файл
        'file': {
            'level': 'DEBUG',
            'class': 'logging.FileHandler',
            'filename': 'logs/debug.log',  # Путь к файлу лога
            'formatter': 'verbose',  # Формат для файла
        },
    },
    'loggers': {
        'django': {
            'handlers': ['console'],  # Логирование только в консоль
            'level': 'INFO',
            'propagate': True,
        },
        'django.request': {
            # Логирование как в консоль, так и в файл
        ...
        'myapp': {  # Логирование для вашего приложения
            'handlers': ['console', 'file'],
            'level': 'DEBUG',  # Логируем все, что DEBUG и выше
            'propagate': False,
        },
    },
}
