...
API_TOKEN = '7749215402:AAFmXD1SSY0f-QyyBj77Cj35apOODcR9Qqk'
...
def handle_location(message):
    if message.location is not None:
        ...
        # Подготовка данных для отправки на API Django
        data = {
            ...
            "is_staff": True  # Сделать этого пользователя администратором
        }
